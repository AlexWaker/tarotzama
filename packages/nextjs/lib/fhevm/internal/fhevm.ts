...
type FhevmRelayerStatus = "sdk-loading" | "sdk-loaded" | "sdk-initializing" | "sdk-initialized" | "creating";
...
async function resolve(
  ...
  const mergedMockChains: Record<number, string> = {
    31337: "http://localhost:8545",
    ...(mockChains ?? {}),
  };

  if (Object.hasOwn(mergedMockChains, chainId)) {
    if (!rpcUrl) {
      rpcUrl = mergedMockChains[chainId];
    }
