      ...
      <div className="relative min-h-screen">
        <div className="relative z-10 flex flex-col items-center px-4">
          ...
          <div className="w-full max-w-6xl space-y-16 pb-12">
            <section className="rounded-[40px] border border-white/10 bg-black/70 px-6 py-8 text-center text-white space-y-5 shadow-[0_30px_100px_rgba(0,0,0,0.6)] sm:px-10 sm:py-10">
